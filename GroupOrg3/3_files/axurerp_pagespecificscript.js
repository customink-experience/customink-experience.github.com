...
SetWidgetRichText('u56', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#CC6600; font-size:13px;">Your updates have been added to the [[GroupName]] sign-up sheet.&nbsp; Now share it with your group!</span></b>'));

SetWidgetRichText('u63', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#515151; font-size:13px;">Share it via email or facebook, then check the dashboard and watch your sign-up list grow.&nbsp; <br>We\'ve sent a link to your dashboard to your email address at [[yourEmail]] and to [[contactName]] at [[contactEmail]].</span>'));

SetWidgetRichText('u107', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#515151; font-size:13px;">The URL to the [[GroupName]] sign up sheet is:&nbsp;&nbsp; http//www.customink/signup/yourgroup.com</span></b>'));

SetWidgetFormText('u68', PopulateVariables('I\'ve created a sign up sheet for our group [[GroupName]].  Click on the link and select your size before the closing date.  Check it out!'));

SetWidgetRichText('u108', PopulateVariables('<span style=" font-family:\'Helvetica\'; font-size:11px;">Welcome [[YourName]]&nbsp; |&nbsp; Not [[YourName]]? <span style=" font-family:\'Helvetica\'; font-size:11px;"> <span style=" font-family:\'Helvetica\'; font-size:11px;"><u>Click Here</u></span></span></span>'));
...
SetWidgetRichText('u111', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#FF6600; font-size:13px;">Customize </span></b>'));

	self.location.href="2.html" + GetQuerystring();

SetWidgetRichText('u113', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;">View</span>'));

SetWidgetRichText('u115', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;">Share</span>'));

SetWidgetRichText('u117', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;">Manage</span>'));
...
SetWidgetRichText('u111', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;">Customize </span></b>'));
...
SetWidgetRichText('u111', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;">Customize </span>'));
...
SetWidgetRichText('u113', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#FF6600; font-size:13px;">View</span></b>'));
...
SetWidgetRichText('u113', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;">View </span></b>'));
...
SetWidgetRichText('u28', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#515151; font-size:12px;">[[contactName]]</span>'));

SetWidgetRichText('u29', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006699; font-size:12px;">[[contactEmail]]</span>'));

SetWidgetRichText('u30', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#515151; font-size:12px;">[[contactPhone]]</span>'));

SetWidgetRichText('u34', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#515151; font-size:12px;">[[paymtInfo]]</span>'));

SetWidgetRichText('u38', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#515151; font-size:12px;">[[dlvyInfo]]</span>'));

SetWidgetRichText('u42', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#339933; font-size:32px;">6</span></b>'));

SetWidgetRichText('u43', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#339933; font-size:12px;">[[closeDate]]</span>'));
...
SetWidgetRichText('u117', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#FF6600; font-size:13px;">Share </span></b>'));
...
if (bIE) u117.attachEvent("onmouseover", MouseOveru117);
else u117.addEventListener("mouseover", MouseOveru117, true);
function MouseOveru117(e)
{
if (!IsTrueMouseOver('u117',e)) return;
if (true) {

SetWidgetRichText('u117', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;">Manage</span></b>'));

}

}

if (bIE) u117.attachEvent("onmouseout", MouseOutu117);
else u117.addEventListener("mouseout", MouseOutu117, true);
function MouseOutu117(e)
{
...
SetWidgetFormText('u67', PopulateVariables(''));
...
SetWidgetFormText('u68', PopulateVariables(' '));
