...
eval(GetDynamicPanelScript('u333', 2));
...
eval(GetDynamicPanelScript('u346', 2));

eval(GetDynamicPanelScript('u303', 1));

eval(GetDynamicPanelScript('u370', 1));

eval(GetDynamicPanelScript('u312', 2));

eval(GetDynamicPanelScript('u475', 3));
...
if (true) {
	...
	MoveWidgetTo('u370',15,450);

	SetPanelStateu475("pd2u475");
...
if (true) {
	...
	SetPanelStateu346("pd0u346");

	SetPanelStateu475("pd0u475");

	SetPanelVisibilityu357("");
...
if (true) {
	...
	SetPanelStateu346("pd1u346");

	SetPanelStateu475("pd1u475");

	SetPanelVisibilityu357("hidden");
