...
var PageName = 'Copy of Welcome Page';
var PageId = 'p53658223686d4f49a81335dbbe9e0870'
var PageUrl = 'Copy_of_Welcome_Page.html'
document.title = 'Copy of Welcome Page';
...
eval(GetDynamicPanelScript('u327', 2));
...
eval(GetDynamicPanelScript('u492', 2));
...
eval(GetDynamicPanelScript('u306', 2));

eval(GetDynamicPanelScript('u410', 1));
...
eval(GetDynamicPanelScript('u416', 1));
...
eval(GetDynamicPanelScript('u354', 5));
...
eval(GetDynamicPanelScript('u398', 2));

eval(GetDynamicPanelScript('u511', 2));
...
SetWidgetRichText('u573', PopulateVariables('<span style=" font-family:\'Helvetica\'; font-size:13px;">&nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;"> 14&quot; </span><span style=" font-family:\'Helvetica\'; font-size:13px;">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#CC0000; font-size:13px;">23.5&quot;</span>'));

SetWidgetRichText('u557', PopulateVariables('<div style="text-align:center"><b><span style=" font-family:\'Arial\'; color:#0066CC; font-size:12px;">YS</span></b><span style=" font-family:\'Arial\'; color:#797979; font-size:12px;"> | YM | YL | YXL</span></div>'));

SetWidgetRichText('u578', PopulateVariables('<span style=" font-family:\'Calibri\'; font-size:11px;">Length:<span style=" font-family:\'Calibri\'; font-size:11px;"> from shoulder seam at collar to bottom of the hem<br><span style=" font-family:\'Calibri\'; font-size:11px;">Width: <span style=" font-family:\'Calibri\'; font-size:11px;">&nbsp; from armhole to armhole across the chest</span></span></span></span>'));
...
SetWidgetRichText('u573', PopulateVariables('<div style="text-align:center"><span style=" font-family:\'Calibri\'; color:#868686; font-size:11px;">Roll over a size to see measurements</span></div>'));

SetWidgetRichText('u557', PopulateVariables('<div style="text-align:center"><span style=" font-family:\'Arial\'; color:#797979; font-size:12px;">YS | YM | YL | YXL</span></div>'));

SetWidgetRichText('u578', PopulateVariables('<span style=" font-family:\'Calibri\'; color:#006699; font-size:11px;"> </span>'));
...
SetWidgetRichText('u573', PopulateVariables('<span style=" font-family:\'Helvetica\'; font-size:13px;">&nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;"> 15&quot; </span><span style=" font-family:\'Helvetica\'; font-size:13px;">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#CC0000; font-size:13px;">24.5&quot;</span>'));

SetWidgetRichText('u557', PopulateVariables('<div style="text-align:center"><span style=" font-family:\'Arial\'; color:#797979; font-size:12px;">YS | </span><span style=" font-family:\'Arial\'; color:#0066CC; font-size:12px;"><b>YM</span></b><span style=" font-family:\'Arial\'; color:#797979; font-size:12px;"> | YL | YXL</span></div>'));
...
SetWidgetRichText('u573', PopulateVariables('<span style=" font-family:\'Helvetica\'; font-size:13px;">&nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;"> 16&quot; </span><span style=" font-family:\'Helvetica\'; font-size:13px;">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#CC0000; font-size:13px;">25.5&quot;</span>'));

SetWidgetRichText('u557', PopulateVariables('<div style="text-align:center"><span style=" font-family:\'Arial\'; color:#797979; font-size:12px;">YS | YM | </span><span style=" font-family:\'Arial\'; color:#0066CC; font-size:12px;"><b>YL</span></b><span style=" font-family:\'Arial\'; color:#797979; font-size:12px;"> | YXL</span></div>'));
...
if (bIE) u576.attachEvent("onmouseout", MouseOutu576);
else u576.addEventListener("mouseout", MouseOutu576, true);
function MouseOutu576(e)
{
if (!IsTrueMouseOut('u576',e)) return;
if (true) {
...
SetWidgetRichText('u573', PopulateVariables('<span style=" font-family:\'Helvetica\'; font-size:13px;">&nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;"> 17&quot; </span><span style=" font-family:\'Helvetica\'; font-size:13px;">&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#CC0000; font-size:13px;">26.5&quot;</span>'));

SetWidgetRichText('u557', PopulateVariables('<div style="text-align:center"><span style=" font-family:\'Arial\'; color:#797979; font-size:12px;">YS | YM | YL | </span><span style=" font-family:\'Arial\'; color:#0066CC; font-size:12px;"><b>YXL</span></b></div>'));
