...
var PageName = 'Copy of New Welcome Page';
var PageId = 'p7c7c7d0f73b54adebf8a5cf89ab66e41'
var PageUrl = 'Copy_of_New_Welcome_Page.html'
document.title = 'Copy of New Welcome Page';
...
eval(GetDynamicPanelScript('u617', 5));

eval(GetDynamicPanelScript('u155', 1));

eval(GetDynamicPanelScript('u405', 3));

eval(GetDynamicPanelScript('u715', 1));
...
eval(GetDynamicPanelScript('u661', 4));
...
eval(GetDynamicPanelScript('u730', 1));

eval(GetDynamicPanelScript('u356', 3));

eval(GetDynamicPanelScript('u0', 1));

eval(GetDynamicPanelScript('u735', 1));
...
eval(GetDynamicPanelScript('u649', 2));
...
if (true) {
	...
	SetPanelStateu617("pd3u617");

	SetPanelStateu435("pd1u435");

	MoveWidgetTo('u730',11,300);
...
if (true) {
	...
	SetPanelStateu649("pd1u649");

	SetPanelStateu661("pd1u661");

	MoveWidgetTo('u715',287,305);

	MoveWidgetTo('u730',11,520);
...
if (true) {
	...
	SetPanelStateu649("pd0u649");

	SetPanelStateu661("pd2u661");

	MoveWidgetTo('u715',287,100);

	MoveWidgetTo('u730',11,311);
...
if (true) {
	...
	SetPanelStateu661("pd0u661");

SetWidgetRichText('u722', PopulateVariables('<b><span style=" font-family:\'Calibri\'; color:#006699; font-size:13px;">Total:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $12.00</span></b>'));
...
SetWidgetRichText('u722', PopulateVariables('<b><span style=" font-family:\'Calibri\'; color:#006699; font-size:13px;">Total:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $120.00</span></b>'));
