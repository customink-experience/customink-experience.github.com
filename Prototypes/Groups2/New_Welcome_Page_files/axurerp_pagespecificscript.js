...
eval(GetDynamicPanelScript('u938', 2));
...
eval(GetDynamicPanelScript('u850', 2));

eval(GetDynamicPanelScript('u3', 7));

eval(GetDynamicPanelScript('u928', 1));
...
eval(GetDynamicPanelScript('u824', 2));
...
if ((GetGlobalVariableValue('$NameNum')) == (PopulateVariables('no'))) {
	...
	SetPanelStateu824("pd0u824");

	SetPanelStateu3("pd6u3");

	SetPanelStateu850("pd1u850");

	MoveWidgetTo('u928',28,200);
...
if ((GetGlobalVariableValue('$NameNum')) == (PopulateVariables('yes'))) {
	...
	SetPanelStateu850("pd0u850");

	SetPanelStateu824("pd1u824");

	MoveWidgetTo('u928',28,470);
