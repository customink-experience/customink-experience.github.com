...
SetWidgetFormText('u579', GetGlobalVariableValue('$YourName'));

SetWidgetFormText('u578', GetGlobalVariableValue('$yourEmail'));

SetWidgetRichText('u330', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#003366; font-size:19px;">Customize [[GroupName]] Sign-Up Sheet&nbsp; &nbsp;&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#006699; font-size:13px;"><u>Change Group Name</u></span>'));

SetWidgetFormText('u370', GetGlobalVariableValue('$closeDate'));

SetWidgetFormText('u382', GetGlobalVariableValue('$groupPrice'));

SetWidgetFormText('u394', GetGlobalVariableValue('$paymtInfo'));

SetWidgetFormText('u402', GetGlobalVariableValue('$dlvyInfo'));

SetWidgetFormText('u453', GetGlobalVariableValue('$Welcome'));
...
eval(GetDynamicPanelScript('u366', 1));

eval(GetDynamicPanelScript('u377', 2));

eval(GetDynamicPanelScript('u319', 1));

eval(GetDynamicPanelScript('u11', 2));

eval(GetDynamicPanelScript('u405', 1));
...
eval(GetDynamicPanelScript('u488', 3));

eval(GetDynamicPanelScript('u397', 1));

eval(GetDynamicPanelScript('u432', 1));
...
eval(GetDynamicPanelScript('u396', 1));
...
SetWidgetRichText('u485', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006633; font-size:12px;">Online sign-up will be available until 11:59 pm Eastern Time [[CloseExDate]].&nbsp; After the close date participants will see your sheet but will not be able to sign up online. </span>'));

SetWidgetRichText('u569', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#FF6600; font-size:11px;">2 week FREE delivery to [[ZIP]] by Wednesday, March 9</span></b>'));
...
SetWidgetRichText('u485', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006633; font-size:12px;">Online sign-up will end on [[CloseExDate]] at 11:59pm Eastern Time.&nbsp; After that date, participants will see the sheet but will not be able to sign up online.&nbsp; </span>'));
...
SetWidgetRichText('u558', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#FF6600; font-size:11px;">1 week Rush delivery to [[ZIP]] by:</span></b>'));

SetWidgetRichText('u556', PopulateVariables('<b><span style=" font-family:\'Helvetica\'; color:#FF6600; font-size:11px;">2 week FREE delivery to [[ZIP]] by:</span></b>'));
...
if (bIE) u402.attachEvent("onblur", LostFocusu402);
else u402.addEventListener("blur", LostFocusu402, true);
function LostFocusu402(e)
{

if (true) {

SetGlobalVariableValue('$dlvyInfo', GetWidgetFormText('u402'));
...
SetWidgetFormText('u426', PopulateVariables(''));
...
if (bIE) u426.attachEvent("onblur", LostFocusu426);
else u426.addEventListener("blur", LostFocusu426, true);
function LostFocusu426(e)
{

if (true) {

SetGlobalVariableValue('$Comments', GetWidgetFormText('u426'));
...
SetGlobalVariableValue('$Welcome', GetWidgetFormText('u453'));

SetGlobalVariableValue('$contactEmail', GetWidgetFormText('u578'));

SetGlobalVariableValue('$contactName', GetWidgetFormText('u579'));

SetGlobalVariableValue('$contactPhone', GetWidgetFormText('u582'));
...
if (((GetCheckState('u443')) == (false)) && ((GetCheckState('u464')) == (false))) {
...
if (((GetCheckState('u443')) == (true)) && ((GetCheckState('u464')) == (true))) {
...
if (((GetCheckState('u443')) == (true)) && ((GetCheckState('u464')) == (false))) {

SetGlobalVariableValue('$emaiNew', PopulateVariables('Each time someone  signs up.'));

}
else
if (((GetCheckState('u443')) == (false)) && ((GetCheckState('u464')) == (true))) {
...
if (((GetCheckState('u464')) == (false)) && ((GetCheckState('u443')) == (false))) {
...
if (((GetCheckState('u464')) == (false)) && ((GetCheckState('u443')) == (true))) {

SetGlobalVariableValue('$emaiNew', PopulateVariables('Each time someone signs up.'));

}
else
if (((GetCheckState('u464')) == (true)) && ((GetCheckState('u443')) == (true))) {

SetGlobalVariableValue('$emaiNew', PopulateVariables('Each time someone signs up and when my sign-up sheet closes.'));

}
else
if (((GetCheckState('u464')) == (true)) && ((GetCheckState('u443')) == (false))) {
...
if ((GetCheckState('u466')) == (true)) {

	SetPanelVisibilityu397("");

	MoveWidgetTo('u405',0,120);
...
SetWidgetFormText('u402', PopulateVariables(' '));

	MoveWidgetTo('u405',0,25);
...
if ((GetCheckState('u468')) == (true)) {
	...
	MoveWidgetTo('u396',0,120);

	SetPanelVisibilityu388("");

}
else
if (true) {

	MoveWidgetTo('u396',0,25);

SetGlobalVariableValue('$paymtInfo', PopulateVariables(''));

SetWidgetFormText('u394', PopulateVariables(''));

	SetPanelVisibilityu388("hidden");
...
if ((GetCheckState('u470')) == (true)) {
	...
	MoveWidgetTo('u387',0,120);

	SetPanelStateu377("pd1u377");

}
else
if (true) {

	MoveWidgetTo('u387',0,50);

	SetPanelStateu377("pd0u377");

SetGlobalVariableValue('$groupPrice', PopulateVariables(''));

SetWidgetFormText('u382', PopulateVariables(''));
...
SetWidgetFormText('u370', PopulateVariables(''));
...
if ((GetCheckState('u372')) == (true)) {

SetWidgetFormText('u370', PopulateVariables('mm/dd/yyyy'));
...
if (((GetCheckState('u372')) == (false)) && (((GetWidgetFormText('u370')) != (PopulateVariables('mm/dd/yyyy'))) && ((GetWidgetFormText('u370')) != (PopulateVariables(''))))) {

SetGlobalVariableValue('$closeDate', GetWidgetFormText('u370'));
...
SetWidgetRichText('u485', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006633; font-size:12px;">Your sign-up sheet will remain open until you close it.&nbsp; <br><br>Use “Help me choose a date” to see delivery timeframes for your location.</span>'));
...
if ((GetWidgetFormText('u370')) != (PopulateVariables('mm/dd/yyyy'))) {

SetWidgetRichText('u485', PopulateVariables('<span style=" font-family:\'Arial\'; font-size:13px;">The last day to order for FREE SHIPPING guaranteed by [delivery date] is [order date].&nbsp; </span>'));

}
else
if (true) {

SetWidgetRichText('u485', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#006633; font-size:12px;">Place your order at least 2 weeks in advance of your delivery date to get FREE SHIPPING in the 48 US states and Canada.</span>'));
...
SetWidgetRichText('u485', PopulateVariables(''));
...
SetGlobalVariableValue('$groupPrice', GetWidgetFormText('u382'));
...
SetGlobalVariableValue('$paymtInfo', GetWidgetFormText('u394'));
