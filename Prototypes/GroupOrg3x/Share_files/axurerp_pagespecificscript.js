...
SetWidgetFormText('u111', PopulateVariables('I\'ve created a sign up sheet for our group [[GroupName]].  Click on the link and select your size before the closing date.  Check it out!'));

SetWidgetRichText('u58', PopulateVariables('<span style=" font-family:\'Helvetica\'; color:#515151; font-size:11px;">Not the organizer for [[GroupName]]?&nbsp; </span><span style=" font-family:\'Helvetica\'; color:#006699; font-size:11px;"><u>Click Here</u></span>'));
...
SetWidgetFormText('u110', PopulateVariables(''));
