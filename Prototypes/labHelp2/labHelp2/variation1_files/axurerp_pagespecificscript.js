...
SetWidgetRichText('u36', PopulateVariables('<div style="text-align:right"><span style=" font-family:\'Calibri\'; color:#FFFFFF; font-size:12px;">$0.00</span></div>'));

SetWidgetRichText('u29', PopulateVariables('<div style="text-align:right"><b><span style=" font-family:\'Calibri\'; color:#CC3300; font-size:13px;">$181.26</span></b></div>'));

}
else
if (true) {

SetWidgetRichText('u36', PopulateVariables('<div style="text-align:right"><span style=" font-family:\'Calibri\'; color:#282828; font-size:12px;">$45.31</span></div>'));

SetWidgetRichText('u29', PopulateVariables('<div style="text-align:right"><b><span style=" font-family:\'Calibri\'; color:#CC3300; font-size:13px;">$226.57</span></b></div>'));
