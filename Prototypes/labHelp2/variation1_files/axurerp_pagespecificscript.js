...
var PageName = 'variation1';
var PageId = 'pe860b5ceab824aaf9d7f49368c3d78e7'
var PageUrl = 'variation1.html'
document.title = 'variation1';
...
SetWidgetRichText('u17', PopulateVariables('<span style=" font-family:\'Calibri\'; color:#003399; font-size:11px;"><u>Remove VA tax</u></span>'));

SetWidgetRichText('u19', PopulateVariables('<div style="text-align:right"><span style=" font-family:\'Calibri\'; color:#6B6B6B; font-size:12px;">[[VAtax]]</span></div>'));

SetWidgetRichText('u22', PopulateVariables('<div style="text-align:right"><b><span style=" font-family:\'Calibri\'; color:#CC3300; font-size:13px;">[[IIPrice]]</span></b></div>'));

SetWidgetRichText('u30', PopulateVariables('<div style="text-align:right"><b><span style=" font-family:\'Calibri\'; color:#CC3300; font-size:13px;">[[IIPrice]]</span></b></div>'));
...
SetWidgetRichText('u19', PopulateVariables('<div style="text-align:right"><span style=" font-family:\'Calibri\'; color:#6B6B6B; font-size:12px;">$0.00</span></div>'));

SetWidgetRichText('u22', PopulateVariables('<div style="text-align:right"><b><span style=" font-family:\'Calibri\'; color:#CC3300; font-size:13px;">$181.26</span></b></div>'));

SetWidgetRichText('u30', PopulateVariables('<div style="text-align:right"><b><span style=" font-family:\'Calibri\'; color:#CC3300; font-size:13px;">$181.26</span></b></div>'));
...
if ((GetCheckState('u27')) == (true)) {

SetWidgetRichText('u37', PopulateVariables('<div style="text-align:right"><span style=" font-family:\'Calibri\'; color:#FFFFFF; font-size:12px;">$0.00</span></div>'));
...
SetWidgetRichText('u37', PopulateVariables('<div style="text-align:right"><span style=" font-family:\'Calibri\'; color:#282828; font-size:12px;">$45.31</span></div>'));

SetWidgetRichText('u30', PopulateVariables('<div style="text-align:right"><b><span style=" font-family:\'Calibri\'; color:#CC3300; font-size:13px;">$226.57</span></b></div>'));
